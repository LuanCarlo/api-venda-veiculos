/**
 * Created by Marcony on 31/03/16.
 */
(function(){
    "use strict";
    ...
    function flexCalendar() {
        ...
        var template =
            ...
            '<div class="month">'+
            '<div class="arrow pull-left {{arrowPrevClass}}" ng-click="prevMonth()"></div>'+
            '<div class="label center-block">{{ selectedMonth | translate }} {{selectedYear}}</div>'+
            '<div class="arrow pull-right {{arrowNextClass}}" ng-click="nextMonth()"></div>'+
            '</div>'+
            '<div class="week">'+
