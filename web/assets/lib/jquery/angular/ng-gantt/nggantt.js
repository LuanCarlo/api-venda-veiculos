 ...
 */
var app = angular.module("ngGrantt",[]);
...
app.directive('ngGrantt', [function () {
    ...
    function link($scope, $elm, $attr) {
        try {
            ...
            gantt.config.autofit = typeof config.autofit == "undefined" ? true : config.autofit;
            ...
            gantt.config.details_on_dblclick = typeof config.details_on_dblclick == "undefined" ? true : config.details_on_dblclick;
            gantt.config.details_on_create = typeof config.details_on_create == "undefined" ? true : config.details_on_create;
            ...
            gantt.attachEvent("onLightboxSave", function(id,new_id){
            ...
            $scope.$on("$destroy", function () {
                ...
                gantt.detachEvent('ev_ontaskclick'); delete gantt['ev_ontaskclick'];
                gantt.detachEvent('ev_masteradd'); delete gantt['ev_masteradd'];
                gantt.detachEvent('ev_onaftertaskdrag'); delete gantt['ev_onaftertaskdrag'];
                gantt.detachEvent('ev_onlightboxsave'); delete gantt['ev_onlightboxsave'];
            });
